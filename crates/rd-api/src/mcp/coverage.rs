...
/// The markers the generated table sits between in `crates/rd-api/mcp-coverage.md`.
const BEGIN: &str = "<!-- BEGIN generated: scripts/mcp-coverage.sh -->";
const END: &str = "<!-- END generated -->";

/// The comparison, as `crates/rd-api/mcp-coverage.md` carries it.
///
...
/// keep them equal.
///
/// Same arrangement as `rd_core::failpoint` and `crates/rd-core/recovery-matrix.md`, and for
/// the same reason: a comparison table that has drifted from the code reads as a statement about
/// what is covered, and a reader has no way to tell it stopped being true. The table is
